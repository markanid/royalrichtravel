...
<div class="card card-primary card-outline">
    ...
    <form id="EditUser" method="post" action="{{ route('testimonial.update') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="designation" tabindex="1" class="form-control" value="{{ !empty($user['designation']) ? $user['designation'] : '' }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Message</label>
                        <input type="text" name="message"  tabindex="1" class="form-control" value="{{ !empty($user['message']) ? $user['message'] : '' }}">
					...
					<div class="form-group">
						...
						<div id="photo_preview" class="mt-2">
						    @if(!empty($user) && !empty($user) && !empty($user['image']))
						        <img src="{{asset('uploads/testimonial/'.$user['image'])}}" alt="Employee Photo" style="width: 150px; height: 150px;">
						    @else
