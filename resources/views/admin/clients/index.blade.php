        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm btn-flat float-right" href="{{route('clients.add')}}"><i class="fas fa-plus-circle"></i> Create</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach($about as $row)
                                <tr>
                                    ...
                                    <td> 
                                          <img src="{{ $row->client_image ? asset('uploads/clients/' . $row->client_image) : asset('uploads/avatar.png') }}" width="100" height="70" alt="Description Image">
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm btn-flat" href="{{route('clients.edit', $row->id)}}">
