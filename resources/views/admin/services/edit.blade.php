...
<div class="card card-primary card-outline">
    ...
    <form id="EditUser" method="post" action="{{ route('services.update') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="description" tabindex="1" class="form-control" value="{{ !empty($user['description']) ? $user['description'] : '' }}">
					...
					<div class="form-group">
						...
						<div id="photo_preview" class="mt-2">
						    @if(!empty($user) && !empty($user) && !empty($user['image']))
						        <img src="{{asset('uploads/services/'.$user['image'])}}" alt="Employee Photo" style="width: 150px; height: 150px;">
						    @else
