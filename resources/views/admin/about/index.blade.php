                        ...
                        <tbody>
                            ...
                            @foreach($about as $row)
                                <tr>
                                    ...
                                    <td>{{$row->project_complete}}</td>
                                    <td> 
                                       <img src="{{ $row->image_1 ? asset('uploads/about/' . $row->image_1) : asset('uploads/avatar.png') }}" width="100" height="70" alt="Description Image">
                                    </td>
                                     <td> 
                                        <img src="{{ $row->image_2 ? asset('uploads/about/' . $row->image_2) : asset('uploads/avatar.png') }}" width="100" height="70" alt="Description Image">
                                    <td>
                                        <a class="btn btn-info btn-sm btn-flat" href="{{route('about.edit', $row->about_id)}}">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-sm delete-btn btn-flat" data-id="{{$row->about_id}}" data-toggle="modal" data-target="#modal-sm">
