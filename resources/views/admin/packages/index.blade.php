        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm btn-flat float-right" href="{{route('packages.create')}}"><i class="fas fa-plus-circle"></i> Create</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach($packages as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-sm btn-flat" href="{{route('packages.edit', $row->id)}}"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="#" class="btn btn-danger btn-sm btn-flat delete-btn" data-url="{{ route('packages.delete', ['id' => $row->id]) }}"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
