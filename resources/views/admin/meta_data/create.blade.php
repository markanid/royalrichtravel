            ...
            <div class="row">
                	...
                	<div class="form-group">
    					...
    					<div class="input-group">
    						<div class="custom-file">
    							<input type="file" class="custom-file-input" id="customFile2" tabindex="1" name="og_image">
               ...
               <div class="col-md-3">
                   <div class="form-group">
                       ...
                       <input type="text" name="title" id="title" tabindex="2" class="form-control" value="{{ !empty($meta_data->title) ? $meta_data->title : '' }}">
                       @if ($errors->has('title'))
               ...
               <div class="col-md-5">
                   <div class="form-group">
                       ...
                       <textarea name="desciption" id="desciption" tabindex="3" class="form-control">{{ !empty($meta_data->desciption) ? $meta_data->desciption : '' }}</textarea>
               ...
               <div class="col-md-2">
                   <div class="form-group">
                       ...
                       <textarea name="keyword" id="keyword" tabindex="4" class="form-control">{{ !empty($meta_data->keyword) ? $meta_data->keyword : '' }}</textarea>
